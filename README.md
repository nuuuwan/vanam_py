...
3. **Ingestion:** The backend (this repo) periodically checks the temporary storage for new images and moves them into permanent storage in this repository (`data/images`).
